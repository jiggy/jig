  ...
  return (
    <section className="showcase" aria-labelledby="showcase-title">
      <div className="showcase-intro">
        ...
        <Link className="text-link" href={data.link}>
          {data.linkText}
          <Arrow />
        </Link>
      </div>
      <div className="showcase-instrument">
        <div className="instrument-top">
          <span className="instrument-indicator" aria-hidden="true" />
          <span>{data.label}</span>
          <span className="instrument-index">
            0{selected + 1} / 0{data.stages.length}
          </span>
        </div>
        <div className="method-card showcase-caller">
          <div className="method-file">{data.caller.file}</div>
          <pre tabIndex={0}>
            <code>{data.caller.code}</code>
          </pre>
        </div>
        ...
        >
          ...
          <div className="showcase-explanation">
            <h3>{stage.title}</h3>
        ...
        <div className="showcase-contract">

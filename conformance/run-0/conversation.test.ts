...
import contractSchema from '../../docs/flow/spec/machine/channel-contract-0.schema.json'
...
test('conversation descriptors use the public Channel Contract/0 and Schema/0 profile', () => {
  ...
  return {
    ...
    contract: {
      ...
      digest: `sha256:${createHash('sha256')
        .update('FLOW-Channel-Contract/0\0')

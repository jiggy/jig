...
FIXTURE = json.loads((ROOT / "conformance/run-0/fixtures/conversation.json").read_text())
...
def grant(role, port):
    ...
    digest = hashlib.sha256(b"FLOW-Channel-Contract/0\0" + json.dumps(
    ...
    def exercise(self, analysis_language, mode):
        ...
        with ExitStack() as stack:
            peers = {role: stack.enter_context(HostPeer([
                ...
                str(ROOT / f"conformance/run-0/components/conversation.{language}"),

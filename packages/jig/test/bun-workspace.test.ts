...
async function fixture() {
  ...
  await put(`${target}/flow.ts`, 'import { message } from "helper"; console.log(message)\n')
  ...
  await put('libs/helper/dist/index.js', 'export { message } from "leaf"\n')
...
test.each(['unlocked', 'locked', 'stale'] as const)(
  ...
  async (mode) => {
    ...
    try {
      ...
      expect(output).toBe('workspace bytes\n')

...
(
  ...
  "$FLOW_NODE" --input-type=module -e \
    'const sdk = await import("@jigging/flow"); if (typeof sdk.handle !== "function" || typeof sdk.OperationError !== "function" || typeof sdk.CapabilityError !== "function") process.exit(70)'
)

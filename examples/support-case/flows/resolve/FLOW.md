...
description: Check a disputed charge against supplied records and a fixed credit policy.
outcomes:
  blocked: The assessment method cannot complete its work.
  limit: The assessment method reaches its limit.
---

...
The current prerelease candidate is `0.1.0a2`. Check its
[PyPI version page](https://pypi.org/project/jiggy-flow/0.1.0a2/) for publication.
...
```sh
python -m pip install jiggy-flow==0.1.0a2
```

Before publication, install the candidate wheel from its release build with
`python -m pip install /path/to/jiggy_flow-0.1.0a2-py3-none-any.whl`.

...
<h3>Companies under $1M revenue</h3>
<div className="pricing-card-price">$0 <span>free business use</span></div>
<p>Full operational use in your company or sole proprietorship if your consolidated group revenue was below $1,000,000 in your last financial year.</p>
<ul className="pricing-check-list">
...
<div className="pricing-card pricing-card--featured">
<p className="eyebrow">Any Organization</p>
<h3>Genuine Evaluation</h3>
<div className="pricing-card-price">$0 <span>at any scale</span></div>
<p>Evaluate Jig at any company, enterprise, or team. Run prototypes, benchmarks, security reviews, and integration proofs.</p>
<ul className="pricing-check-list">
...
<div className="pricing-bread-note">
...
<details className="pricing-funding-collapsible">
<summary className="pricing-funding-summary">
...
<div className="pricing-tier-title">$1M – under $10M revenue</div>
<div className="pricing-tier-cost"><span className="tier-amount">$100</span><span className="tier-unit">/ year</span></div>
<p className="pricing-tier-desc">Nominal contribution. One company purchase gives permanent rights to covered releases for your entire group.</p>
</div>
<div className="pricing-tier-card">
<div className="pricing-tier-title">$10M – under $100M revenue</div>
<div className="pricing-tier-cost"><span className="tier-amount">$1,000</span><span className="tier-unit">/ year</span></div>
<p className="pricing-tier-desc">Sustainable support. One company purchase gives permanent rights to covered releases for your entire group.</p>
</div>
<div className="pricing-tier-card">
...
<p>Revenue means your consolidated group's revenue for its last completed financial year using standard accounting rules. It does not include investment capital, funding rounds, company valuation, or employee headcount.</p>
</details>
<details>
...
<p>You assess eligibility once a year. If you cross $1M, you have a 90-day transition period to acquire a company license or discontinue operational use. Earlier free use remains completely valid and free.</p>
</details>
<details>
...
<p>FLOW, Sley, third-party libraries, and Flows you write retain their own licenses. Bread covers only the Jig host software specified in the license adoption notice.</p>
</details>
</div>

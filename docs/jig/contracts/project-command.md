...
native host implementations. The operator separately supplies permitted commands in a
...
A command's completion is not proof of a correct patch. This native invocation does
